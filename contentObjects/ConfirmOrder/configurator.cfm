...
<cfoutput>
	<div id="availableObjectParams"	
		data-object="plugin" 
		data-name="CentLogic Confirmation Page" 
		data-objectid="#$.event('objectID')#">
			
		<dl class="singleColumn">
			
			<!--- heading text shown with cart --->
			<dt>Click Save to insert Confirmation page</dt>
			<dd>
				This adds the order confirmation to your page, no configuration required
			</dd>
		</dl>			
	</div>			
</cfoutput>