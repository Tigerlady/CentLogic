...
==========================================================
File: application.cw.cfc (CentLogic admin)
...
<!--- //////////// --->
<!--- CWMURA [edit]: use mura application settings --->
...
<!--- CWMURA [edit]: not used - mura covers these settings by default : 2011-12-22 --->
...
<!--- CWMURA [edit]: user mura's onrequeststart : 2011-12-22 --->
<cfinclude template="../../../config/appcfc/onRequestStart_include.cfm">

<!--- CWMURA [edit]: redirect to login page if siteid is not available : 2011-12-22 --->
<cfif not ( isDefined('session.siteid') and isDefined('session.dashboardspan') )>
...
<cfif (not isDefined('application.cw.dsn')) or (not len(trim(application.cw.dsn)) gt 0)>
	...
	--->
	<!--- CWMURA [edit]: change path to front end cwapp directory : 2011-12-22 --->
	<cfparam name="request.cwpage.cwapppath" default="../displayObjects/cwapp/">
