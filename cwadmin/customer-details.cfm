...
<!--- CWMURA [edit]: include customer functions : 2012-08-01 --->
<cfinclude template="../displayObjects/cwapp/func/cw-func-mura.cfm">
<!--- CWMURA [end]:  : 2012-08-01 --->
<!--- PAGE PERMISSIONS --->
...
<cfif IsDefined ('form.updateCustomer')>
	...
	<cfelse>
		<!--- CWMURA [edit]: update/create Mura user w/ CentLogic values: 2012-05-22 --->
		<cfset updateID = CWupdateMuraCustomer(
...
<cfif IsDefined ('url.deletecst')>
	...
	<!--- CWMURA [edit]: remove remote ID from any Mura users: 2012-05-22 --->
	<cfquery datasource="#application.cw.dsn#" username="#application.cw.dsnUsername#" password="#application.cw.dsnPassword#">
	UPDATE tusers
	SET remoteID = NULL
	WHERE remoteID = <cfqueryparam value="#url.deletecst#" cfsqltype="cf_sql_varchar">
	</cfquery>
	<!--- CWMURA [end]:  : 2012-05-22 --->
