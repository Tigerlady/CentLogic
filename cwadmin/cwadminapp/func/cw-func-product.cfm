...
Description: Handles all actions for the CentLogic product form (product-details.cfm)
...
Dependencies: Requires admin query functions and CentLogic init functions to be included in calling page
==========================================================
--->
