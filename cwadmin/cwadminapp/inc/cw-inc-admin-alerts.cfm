...
<cfif isDefined('application.cw.appTestModeEnabled') and not application.cw.appTestModeEnabled eq true>
	<cfif isDefined('application.cw.companyemail') AND application.cw.companyemail contains "@CentLogic">
		<cfset CWpageMessage('alert','Please change your <a href="config-settings.cfm?group_ID=3">company email</a>. It is currently set to the CentLogic default value.')>
	</cfif>
</cfif>
