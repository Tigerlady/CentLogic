...
<!--- ADMIN SETTINGS --->
<!--- CWMURA [edit]: remove admin users from cw store menu : 2011-12-22 --->
	<cfif session.cw.accessLevel is 'developer'>
...
<!--- CWMURA [edit]: show mura logo, link to site manager : 2014-07-01 --->
<cfoutput>
<div style="height:27px;">
	<a href="#application.configBean.getContext()#/admin" style="position:absolute; top:-15px; left:10px;">
	<img src="#application.configBean.getContext()#/admin/assets/images/logo_small_feTools.png">
	</a>	
</div>	
</cfoutput>
<!--- CWMURA [end]: show mura logo, link to site manager : 2014-07-01 --->
