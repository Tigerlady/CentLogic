...
<cfif not (isDefined('request.cwpage.viewSiteUrl') and len(trim(request.cwpage.viewSiteUrl)) gt 1)>
	...
	<!--- CWMURA [start]: use mura path for results / details pages : 2011-12-22 --->
	<cfset request.cwpage.storeRoot = application.cw.appCWstoreRoot>
	<cfset request.cwpage.urldetails = cwTrailingChar(request.cwpage.storeRoot,'remove') & cwLeadingChar(listLast(request.cwpage.urldetails,'/'))>
	<cfset request.cwpage.urlresults = cwTrailingChar(request.cwpage.storeRoot,'remove') & cwLeadingChar(listLast(request.cwpage.urlresults,'/'))>
	<!--- CWMURA [end]: use mura path for results / details pages : 2011-12-22 --->
...
<div id="CWadminDashboard">
	...
	<div id="CWadminHelp">
		<a href="http://help.Centricweb.com/CW4_Docs_AdminHelp/index.cfm?pagename=<cfoutput>#request.cwpage.helpFileName#</cfoutput>" class="zoomHelp" rel="external" title="Help for this page">
	...
	<!-- log out -->
<!--- CWMURA [edit]: remove logout link : 2011-12-22 --->
