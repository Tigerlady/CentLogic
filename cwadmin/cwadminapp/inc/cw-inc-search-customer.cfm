...
<cfparam name="form.custType" default="0">
...
<cfquery name="rsCustTypes2" datasource="#application.cw.dsn#" username="#application.cw.dsnUsername#" password="#application.cw.dsnPassword#">
...
<form name="formCustomerSearch" id="formCustomerSearch" method="get" action="customers.cfm">
	...
	<div class="subForm advanced">
		...
		<select name="custType" id="searchCustType">
			...
			<cfoutput query="rsCustTypes2">
			<option value="#rsCustTypes2.customer_type_id#"<cfif rsCustTypes2.customer_type_id eq form.custType>selected="selected"</cfif>>#rsCustTypes2.customer_type_name#</option>
			</cfoutput>			
		</select>
		<!--- rows per page --->
