...
-- ----------------------------
INSERT INTO `cw_admin_users` VALUES ('1', 'Developer', 'developer', 'admin', 'developer', '2011-12-16 17:23:05', '2011-12-16 16:43:12', 'developer@Centricweb.com');
INSERT INTO `cw_admin_users` VALUES ('2', 'Customer Service', 'service', 'admin', 'service', '2011-04-26 16:09:46', '2010-10-11 13:33:34', 'service@Centricweb.com');
INSERT INTO `cw_admin_users` VALUES ('3', 'Manager', 'manager', 'admin', 'manager', '2011-07-18 10:50:59', '2011-04-26 16:10:06', 'manager@Centricweb.com');
INSERT INTO `cw_admin_users` VALUES ('4', 'Merchant', 'merchant', 'admin', 'merchant', '2010-10-11 13:23:11', '2010-04-23 07:43:30', 'merchant@Centricweb.com');
...
INSERT INTO `cw_config_groups` VALUES ('12', 'Cart Pages', '1.000', '0', '1', 'Manage default pages for CentLogic functions');
...
INSERT INTO `cw_config_items` VALUES ('17', '3', 'companyEmail', 'Company Email', 'company@Centricweb.com', 'text', 'This is the company email - all automated emails are sent from this address, and order confirmations are sent to this address', '', '0', '3.000', '35', '0', '1', '1', null);
...
INSERT INTO `cw_config_items` VALUES ('55', '25', 'appVersionNumber', 'CentLogic Version Number', '4.03.01', 'text', 'The current CentLogic version number is stored here for reference when installing or upgrading', 'NULL', '0', '12.000', '0', '0', '1', '1', null);
...
INSERT INTO `cw_config_items` VALUES ('126', '25', 'appSiteUrlHttp', 'Site URL', '', 'text', 'The website root directory url, starting with http://, no trailing slash (e.g. http://www.Centricweb.com )', '', '0', '1.000', '45', '5', '1', '0', null);
...
INSERT INTO `cw_config_items` VALUES ('136', '7', 'adminEditorCSS', 'Text Editor CSS File (file path and name)', 'displayObjects/css/cw-styles.css', 'text', 'The css file used to define text styles in scripted text editors (product descriptions), relative to CW content directory', null, '0', '10.000', '35', '5', '1', '1', null);
...
INSERT INTO `cw_config_items` VALUES ('122', '7', 'adminThemeDirectory', 'Theme Directory', 'neutral', 'select', 'The directory for CentLogic admin theme stylesheet and graphics', '', '0', '11.000', '35', '5', '1', '1', null);
...
INSERT INTO `cw_config_items` VALUES ('150', '27', 'mailHeadText', 'Email Heading (Text)', 'Our CentLogic Site : Centricweb.com', 'textarea', 'Text inserted into all emails sent from the site, at the beginning of the message body.', '', '0', '5.000', '45', '4', '1', '0', null);
INSERT INTO `cw_config_items` VALUES ('151', '27', 'mailHeadHtml', 'Email Heading (HTML)', '<h2><strong>Our CentLogic Site : Centricweb.com</strong></h2>', 'texteditor', 'Formatted text inserted into all HTML-version emails sent from the site, at the beginning of the message body.', '', '0', '6.000', '45', '5', '1', '0', null);
...
INSERT INTO `cw_config_items` VALUES ('153', '27', 'mailFootHtml', 'Email Signature (HTML)', '<p><em><strong>Thank you for choosing <a href=\"http://www.Centricweb.com\">Our Site</a> for your online purchase!</strong></em></p>', 'texteditor', 'Text inserted into all emails sent from the site, at the end of the message body.', '', '0', '8.000', '45', '5', '1', '0', null);
...
INSERT INTO `cw_config_items` VALUES ('182', '3', 'companyURL', 'Company Url', 'http://www.Centricweb.com', 'text', 'The web address as shown in email messages, does not have to be the same as the site home page or other global URL settings.', '', '0', '2.000', '35', '5', '1', '1', null);
...
-- CWMURA EDIT PATH FOR MURA LOCATION --
INSERT INTO `cw_config_items` VALUES ('198', '25', 'appCWContentDir', 'CW Content Path: CAUTION!', '/plugins/CentLogic/displayObjects/', 'text', 'File path from server web root to CentLogic\'s content directory. This is for a file path only, not used for URLs. Value is usually  \'/plugins/CentLogic/displayObjects/\' NOTE: should include trailing slash', '', '0', '2.100', '35', '5', '1', '1', null);
-- CWMURA EDIT PATH FOR MURA LOCATION --
INSERT INTO `cw_config_items` VALUES ('199', '25', 'appCWStoreRoot', 'CW Store Root: CAUTION!', '/index.cfm/store/', 'text', 'Path from site root to page containing CW master content, added to prefix of nav urls and form actions. Value is usually  \'/index.cfm/store/\' ', '', '0', '2.2', '35', '5', '1', '0', null);
-- CWMURA EDIT PATH FOR MURA LOCATION --
INSERT INTO `cw_config_items` VALUES ('200', '25', 'appCWAdminDir', 'CW Admin Directory: CAUTION!', '/plugins/CentLogic/cwadmin/', 'text', 'Path from site root to CentLogic\'s admin directory, used for admin URLs. Value is usually \'/plugins/CentLogic/cwadmin/\' NOTE: should include trailing slash', '', '0', '2.400', '35', '5', '1', '1', '');
...
-- CWMURA EDIT PATH FOR MURA LOCATION --
INSERT INTO `cw_config_items` VALUES ('247', '25', 'appCWAssetsDir', 'CW Assets Directory: CAUTION!', '/plugins/CentLogic/displayObjects/', 'text', 'Path from site root to CentLogic file contents, added to prefix of css and javascript src attributes. Value is usually \'/plugins/CentLogic/displayObjects/\' NOTE: should include trailing slash', '', '0', '2.300', '35', '5', '1', '0', '');
