...
<div id="CWcart" class="CWcontent">
	...
	<cfif itemcount gt 0>
		...
		<cfmodule template="cwapp/mod/cw-mod-cartpreviewdisplay.cfm"
		cart="#CWcart#"
		...
		>
		<!--- CHECKOUT BUTTON --->
		<cfoutput><p class="CWright"><a href="#request.cwpage.checkoutHref#" class="CWcheckoutLink" id="CWlinkCheckout"><i class="fa fa-lock"></i>  Secure Check Out&nbsp;&raquo;</a></p></cfoutput>
