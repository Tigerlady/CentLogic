...
The payment method(s) available are selectable in the CentLogic admin.
					...
					<cfif (not isDefined('session.cwclient.cwCustomerID') or not isDefined('session.cwclient.cwCustomerType') or session.cwclient.cwCustomerID is 0 or session.cwclient.cwCustomerType is 0)
						...
						<div class="halfLeft">
							...
							<div class="center top40">
								...
								<cfelse>
									<a id="CWlinkSkipLogin" class="CWcheckoutLink" href="#" style="">New Customers Create Account&nbsp;&raquo;</a>
								</cfif>
							</div>
						</div>
						<!--- LOGIN FORM --->
