...
Description: handles all email (cfmail) functions for the CentLogic application
==========================================================
Usage:
...
Global options for header, footer, plain text or html, are managed in CentLogic admin
