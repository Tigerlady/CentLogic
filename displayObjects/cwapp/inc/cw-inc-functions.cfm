...
Description: includes all required functions for CentLogic pages
...
<cftry>
	...
	<!--- CWMURA [edit]: include mura custom functions : 2012-08-18 --->
	<!--- mura cms functions --->
	<cfif not isDefined('variables.CWupdateMuraCustomer')>
		<cfinclude template="../func/cw-func-mura.cfm">
	</cfif>
